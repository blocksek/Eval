...
class TicketTeamProvider(TeamProvider):
    DEFAULT_API_URL = "https://ctf.paradigm.xyz/api/internal/check-ticket"
    ...
    def __init__(self, challenge_id: str, api_url: Optional[str] = None):
        self.__challenge_id = challenge_id
        self.__api_url = api_url or os.getenv("TICKET_API_URL", self.DEFAULT_API_URL)
    ...
    def get_team(self):
        ...
        # Accept wildcard tickets ("*") or exact challenge match
        if ticket.challenge_id != "*" and ticket.challenge_id != self.__challenge_id:
            print("invalid ticket!")
            return None
